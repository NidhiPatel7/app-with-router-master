...
import {navigate} from "@reach/router";//from navigate https://reach.tech/router/tutorial/09-navigate after add data show data on list
...
class RouteEditProject extends Component {
    ...
    handleFormSubmit = (e) => {
        ...
        var {id} = this.props;
        updateProjects(id,data).then(res => navigate('/projects'))//navigate is like go to another page
	}
  // componentDidMount()
  // {
  //   console.log('RouteAddProject mounted');
  // }
  render(){
